...
A machine learning project to predict student dropout using various features from student data.

## Features

- Predict student dropout probability
- Web-based interface using Flask
- Pre-trained model with feature selection
...
1. Clone the repository:
   ```
   git clone https://github.com/anusreeanil1810-hub/AIML-PROJ.git
   cd aiml
   ```
...
1. Upload or input student data features.
2. Click on "Predict" to get the dropout probability.
3. View the results on the result page.

## Dataset

The project uses a student dropout dataset (`data/student_dropout.csv`) containing various student attributes.
...
- Feature selection implemented in `src/feature_selection.py`
...
- `src/`: Source code directory
  ...
  - `train_reduced_model.py`: Model training
